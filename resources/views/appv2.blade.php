    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('/vehiculosview') }}"><i class="fas fa-car me-1"></i> Ver Vehículos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('/asignacionserview') }}"><i class="fas fa-tools me-1"></i> Asignación de Servicios</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('/trabjview') }}"><i class="fas fa-users me-1"></i> Trabajadores</a>
                </li>
            </ul>
