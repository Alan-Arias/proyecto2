    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">                    
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/asignacionserview') }}"><i class="fas fa-money-bill-alt me-1"></i>Asignacion de Servicios</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/trabjview') }}"><i class="fas fa-money-bill-alt me-1"></i>Asignacion de Servicios</a>
                </li>
            </ul>
        </div>
    </div>
